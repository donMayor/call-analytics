...
angular.module('usage_trend.byLine', [])
    .controller('usage_trend.byLinesCtrl', function( usgTrndByLineService, $scope, $anchorScroll, $location, $filter, anchorSmoothScroll ){
        ...
        $scope.runLinesQuery = function( param ){
            ...
            usgTrndByLineService.getByLines( _param )
        ...
        */
        ...
        $scope.dwGraph = function(){
            ...
            var myNewChart2 = new Chart(ctx2).Pie(mntCost);
        }
    ...
    .service('usgTrndByLineService', ['$http', function( $http){

        this.getByLines = function( param ) {
            var base_url = "http://localhost/CallAnalytics/public/api/usage_trend/lines/"+param;
