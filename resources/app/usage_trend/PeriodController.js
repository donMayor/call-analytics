...
angular.module('usage_trend.byPeriod', [])
    .controller('usage_trend.byPeriodCtrl', function( usgTrndByPeriodService, $scope, $location, $anchorScroll, anchorSmoothScroll){
        ...
        $scope.runLinesQuery = function( param ){
            ...
            usgTrndByPeriodService.getByPeriod( _param )
    ...
    .service('usgTrndByPeriodService',['$http', function($http){
        this.getByPeriod = function( param ) {
            var base_url = "http://localhost/CallAnalytics/public/api/usage_trend/period/"+param;
